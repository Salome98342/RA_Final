...
const Estudiante: React.FC = () => {
  ...
  // 'peso' sort option removed (visual only)
            ...
            <section className="panel shown">
              ...
              {!loading && tasks.length === 0 ? (
                ...
                <ul className="list-group ra-list-group">
                  {tasks.map(t => (
                    <li key={t.id} className="list-group-item d-flex justify-content-between align-items-center" title="Abrir curso" onClick={()=>{
          ...
          {selected && selectedRA && !selectedActivity && (
            <section className="panel shown">
              <div className="d-flex gap-2 align-items-center mb-2">
                ...
                <label htmlFor="sort-order" className="ms-auto ra-small">Ordenar por</label>
                <select id="sort-order" className="form-select" value={sortBy} onChange={e=>setSortBy(e.target.value as 'fecha'|'nombre')} title="Ordenar por">
