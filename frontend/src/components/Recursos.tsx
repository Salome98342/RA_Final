  ...
  <div className="dashboard-body min-vh-100">
      ...
      <div className="dash-wrapper">
        ...
        <main className="dash-content" onDragOver={(e)=>{ e.preventDefault(); setDrag(true) }} onDragLeave={()=>setDrag(false)} onDrop={onDrop}>
          ...
          <div ref={dropRef} className={`ra-card mb-3 ${drag ? 'border border-danger border-2' : ''}`}><div className="ra-card-body">
              ...
              {items.map(r => (
                <li key={r.id} className="list-group-item d-flex justify-content-between align-items-center">
                  <div
                    ...
                    onKeyDown={(e)=>{ if(e.key === 'Enter' || e.key === ' ') { e.preventDefault(); window.open(r.url, '_blank') } }}
                  >
                    <div>{r.titulo}</div>
