...
const Dashboard: React.FC = () => {
  ...
  const moduleCards = [
    ...
    { key: 'desempenio', icon: 'bi-graph-up-arrow', title: 'Desempeño', desc: 'Analizar estudiantes con bajo desempeño y asignaturas con estudiantes con bajo desempeño.' },
    { key: 'asignaturas', icon: 'bi-journals', title: 'Asignaturas', desc: 'Consultar asignaturas, avance por RA e indicadores.' },
  ...
  return (
    <RoleHomeLayout
      ...
      welcomeDescription="Desde este módulo puedes administrar la operación académica: asignaturas, docentes, estudiantes, matrícula, estructura de RAs e importaciones masivas."
