...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'ra.manager.univalle@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'cpdvphsllwkksdsi')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'ra.manager.univalle@gmail.com')
...
# Contraseña provisional para cuentas creadas por carga masiva de estudiantes
# IMPORTANTE: cámbiala por una contraseña temporal institucional
DEFAULT_BULK_STUDENT_PASSWORD=Estudiante123*
...
SPECTACULAR_SETTINGS = {
    ...
    'CONTACT': {
        ...
        'email': 'ra.manager.univalle@gmail.com',
    },
